...
module.exports = {
  ...
  stringifyBalance (balance, bnDecimals, formattingDecimals) {
    if (balance.eq(zero)) {
      return '0'
    }

    if (!formattingDecimals) {
      formattingDecimals = 5;
    }
    ...
    const fractional = bal.substr(decimalIndex, formattingDecimals)
